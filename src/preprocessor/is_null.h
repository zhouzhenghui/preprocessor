...
/**
 * @brief Test whether the input is the NULL identity.
 * @param a: the input argument to test.
 * @return 1 if the argument is NULL, 0 otherwise.
 * @see __PP_IS_VOID_CAST()
 */
#define __PP_IS_NULL(a) /* Empty definition for Doxygen */
#undef __PP_IS_NULL
